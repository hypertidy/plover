...
extern "C" SEXP _plover_InPoly_cpp(SEXP xx, SEXP yy, SEXP px, SEXP py) {
  BEGIN_CPP11
...
extern "C" SEXP _plover_InPoly_clipper(SEXP xx, SEXP yy, SEXP px, SEXP py, SEXP xyeps) {
  BEGIN_CPP11
...
extern "C" SEXP _plover_inside_loop_x_y(SEXP xx, SEXP yy, SEXP lpx, SEXP lpy, SEXP xyeps) {
  BEGIN_CPP11
...
extern "C" SEXP _plover_inside_point_cull(SEXP xx, SEXP yy, SEXP extents) {
  BEGIN_CPP11
...
extern "C" SEXP _plover_inside_loop_mat(SEXP xx, SEXP yy, SEXP lpxy, SEXP xyeps) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_plover_InPoly_clipper",    (DL_FUNC) &_plover_InPoly_clipper,    5},
    {"_plover_InPoly_cpp",        (DL_FUNC) &_plover_InPoly_cpp,        4},
    {"_plover_inside_loop_mat",   (DL_FUNC) &_plover_inside_loop_mat,   4},
    {"_plover_inside_loop_x_y",   (DL_FUNC) &_plover_inside_loop_x_y,   5},
    {"_plover_inside_point_cull", (DL_FUNC) &_plover_inside_point_cull, 3},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_plover(DllInfo* dll){
